...
if ! python3 -c "import flask" &>/dev/null; then
  echo -e "${GOLD}⚠${NC}  Flask not found. Installing..."
...
echo ""
echo -e "  ${GOLD}To change password on Render:${NC}"
echo -e "    Set ADMIN_PASSWORD env var in Render dashboard, then redeploy."
echo ""
